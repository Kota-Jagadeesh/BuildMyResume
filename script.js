...
const sampleData = {
  personal: {
    fullName: "jagadeesh kota",
    phone: "+1 (123) 456-7890",
    email: "kota.jagadesh123@email.com",
    linkedin: "linkedin.com/in/jagadeeshwar-reddy-kota",
    github: "github.com/kota-jagadeesh",
    twitter: "x.com/kota_jagadeesh_",
  },
  summary:
    "Undergraduate student pursuing AI and DS with experience in Java, C/C++, JavaScript, and Python.",
  education: [
    {
      institution: "Amrita vishwa vidyapeetham",
      degree: "Bachelor of Science in AI & Data science",
      gpa: "1/10.0",
  ...
  experience: [
    {
      title: "Undergraduate",
      company: "Amrita vishwa vidyapeetham University",
...
function setupEventListeners() {
  ...
  // Disable interactions on preview area
  setupPreviewInteractionDisabling();
}
...
// Disable preview area interactions
function setupPreviewInteractionDisabling() {
  ...
  if (previewArea) {
    ...
    // Disable drag events
    previewArea.addEventListener("dragstart", function (e) {
      e.preventDefault();
      return false;
    });

    previewArea.addEventListener("drag", function (e) {
      e.preventDefault();
      return false;
    });
  ...
  if (previewPanel) {
    // Also disable on the preview panel container
    previewPanel.addEventListener("contextmenu", function (e) {
      e.preventDefault();
      return false;
    });

    previewPanel.addEventListener("dragstart", function (e) {
      e.preventDefault();
      return false;
    });

    previewPanel.addEventListener("selectstart", function (e) {
      e.preventDefault();
      return false;
    });
  }
  ...
  const educationHTML = `
        <div class="entry-item" data-type="education" data-index="${index}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="institution" placeholder=" University" oninput="updatePreview()">
            </div>
            <div class="form-group">
                <label>Degree</label>
                <input type="text" class="degree" placeholder="Bachelor of Science" oninput="updatePreview()">
            </div>
            <div class="form-group">
                <label>GPA (Optional)</label>
                <input type="text" class="gpa" placeholder="1.0/10" oninput="updatePreview()">
            </div>
            <div class="form-group">
                <label>Dates</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="location" placeholder="Keralaa" oninput="updatePreview()">
            </div>
        </div>
    `;
...
function addExperience() {
  ...
  const experienceHTML = `
        <div class="entry-item" data-type="experience" data-index="${index}">
            ...
            <div class="form-group">
                <label>Location</label>
                <input type="text" class="location" placeholder="Kerala" oninput="updatePreview()">
            </div>
  ...
  const certificationHTML = `
        <div class="entry-item" data-type="certification" data-index="${index}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="title" placeholder="Machine learning" oninput="updatePreview()">
            </div>
            <div class="form-group">
                <label>Issuing Organization</label>
                <input type="text" class="issuer" placeholder="Amrita University" oninput="updatePreview()">
            </div>
            <div class="form-group">
                <label>Date</label>
...
// Export functions - All exports are free!
...
const NotificationSystem = {
  ...
  show(message, type = "info", duration = null, title = "") {
    ...
    // No auto-removal - notifications stay until manually closed
  ...
  success(message, title = "") {
    return this.show(message, "success", null, title);
  },

  error(message, title = "") {
    return this.show(message, "error", null, title);
  },

  warning(message, title = "") {
    return this.show(message, "warning", null, title);
  },

  info(message, title = "") {
    return this.show(message, "info", null, title);
  },
...
function exportToPDF() {
  ...
  html2pdf()
    ...
    .save()
    .then(() => {
      // Show watermark again after export
      watermark.style.display = "block";
      NotificationSystem.success(
        "Your resume PDF has been downloaded successfully! 📄✨",
        "Export Complete"
      );
    });
}

// Export to Image (after payment)
function exportToImage() {
  ...
  html2canvas(element, {
    ...
    NotificationSystem.success(
      "Your resume image has been downloaded successfully! 🖼️✨",
      "Export Complete"
    );
  });
}
...
function saveResumeData() {
  ...
  NotificationSystem.success(
    "Your resume data has been saved locally! 💾",
    "Data Saved"
  );
}
...
function loadResumeData() {
  ...
  if (savedData) {
    ...
    NotificationSystem.success(
      "Your resume data has been loaded from local storage! 📁",
      "Data Loaded"
    );
  } else {
    NotificationSystem.info(
      'No saved data found. Use "Load Sample" to get started! 📝',
      "No Data Found"
    );
  }
}
...
// Developer tools are now enabled for debugging and development purposes
